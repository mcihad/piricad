...
`test_proof.cpp`   — **the Phase-0 keystone proof** (kentoscad.md §16.5): the same
...
The harness is doctest, pinned in `cmake/KentOSCadDependencies.cmake`.
`tests/support/kentos_test.hpp` adds one macro doctest has no concept of —
