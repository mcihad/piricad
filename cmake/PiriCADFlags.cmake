...
#
# Compile flags. piricad.md §7.3 — these are not preferences.
#
...
add_library(piricad_flags INTERFACE)

if(MSVC)
    target_compile_options(piricad_flags INTERFACE
...
foreach(_flag IN ITEMS CMAKE_CXX_FLAGS CMAKE_CXX_FLAGS_RELEASE CMAKE_CXX_FLAGS_DEBUG)
    if("${${_flag}}" MATCHES "fast-math|fp:fast|ffp-contract=fast")
        message(FATAL_ERROR
            "${_flag} contains a fast-math style flag. Banned by piricad.md §7.3: "
