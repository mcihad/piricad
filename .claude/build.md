...
R12a. The mandatory dependencies — Qt 6, Qt Advanced Docking System (§9.4), HarfBuzz, FreeType, msdfgen — MUST be `find_package`d unconditionally with a pinned minimum version and MUST hard-fail when absent; they carry no `KENTOS_WITH_*` option.
