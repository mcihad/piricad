...
.PHONY: help setup build rebuild run run-script test bench check gates \
        ...
        clean distclean install package asan headless app
...
reference: build ## Regenerate docs/COMMANDS.md from the command registry
	@$(BIN)/piricad --help >/dev/null 2>&1 || true
	@echo "reference: generated by the registry — see Registry::markdown_reference()"
