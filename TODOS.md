...
- [ ] **C-07 · P0 — Tutamaç, vertex ve stretch bütünlüğü.** Mevcut semantik grips altyapısını eğriler, çoklu seçim, blok dönüşümleri ve Z düzenleme ile tamamla; vertex ekle/sil/sürükle ve segment tipini değiştir.
  ...
  **Durum (23 Eylül 2026, 1. aşama):** Tutamak anlamları düzeltildi (`tests/unit/test_grips.cpp`): dairenin çeyrek tutamağı daire kalarak yarıçapı kuruyor; yayın ucu taşınınca **öbür uç yerinde kalıyor** ve yay üç noktadan kuruluyor (eskiden merkez sabit kalıp öbür uç kayıyor, saklanan uç çemberin dışında kalıyordu), yay ortası iki ucu tutarak yayı yeni noktadan geçiriyor, kirişin öbür yanına geçince yön dönüyor; ESNET bütün yayı kaymadan taşıyor. Spline tutamakları kontrol noktaları, seçiliyken kesikli kontrol çerçevesi çiziliyor; kontrol noktası taşınınca dosyadan gelen uydurma noktaları düşüyor. Blok referansına döndürme tutamağı (ESNET döndürmez). ESNET atladığını sebebiyle söylüyor (kilitli katman / tanınmayan tür). Yol üstünde: seçili blok referansının yalnız ilk parçası vurgulanıyordu (fare probu). Kalan: tıkla-taşı-tıkla sıcak tutamak, çoklu seçimde ortak köşe, köşe silme, kenar türü, kilitli tutamakların açıklanması, Z.
