...
| **Düzen** | Geri Al (**Ctrl+Z**), Yinele (**Ctrl+Shift+Z**), Tümünü Seç (**Ctrl+A**), Seçimi Temizle (**Ctrl+Shift+A**), Ayarlar… (**Ctrl+,** — sonunda **Proje Ayarları** ve **Proje Öznitelikleri** sayfaları) |
